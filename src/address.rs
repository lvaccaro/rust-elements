...
mod test {
    ...
    fn test_blech32_vectors() {
        ...
        let address: Result<Address, _> = "el1qq0umk3pez693jrrlxz9ndlkuwne93gdu9g83mhhzuyf46e3mdzfpva0w48gqgzgrklncnm0k5zeyw8my2ypfsmxh4xc8t604m".parse();
        assert_eq!(
            address.err().unwrap().to_string(),
            "v0 witness program must use b(l)ech32 not b(l)ech32m",
        );

        let address: Result<Address, _> = "ert130xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vq4q68pj".parse();
        assert_eq!(
            address.err().unwrap().to_string(),
            "invalid witness script version: 17",
        );

        let address: Result<Address, _> = "el1pq0umk3pez693jrrlxz9ndlkuwne93gdu9g83mhhzuyf46e3mdzfpva0w48gqgzgrklncnm0k5zeyw8my2ypfsqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqfvf9vmrp4s9s".parse();
        assert_eq!(
            address.err().unwrap().to_string(),
        ...
        let address: Result<Address, _> = "rrr1qq0umk3pez693jrrlxz9ndlkuwne93gdu9g83mhhzuyf46e3mdzfpva0w48gqgzgrklncnm0k5zeyw8my2ypfszcf5ykzvpgtg".parse();
        assert_eq!(
            address.err().unwrap().to_string(),
